...
//            legalMoves.add((Move) piece.calculateLegalMoves(this));
    ...
    public static class Builder{
        ...
        /**
         * Method that set a given piece on a board
         * @param piece piece
         * @return builder
         */
        ...
        /**
         * Method that sets colour that moves next
         * @param colourThatMovesNext colour
         * @return builder
         */
        ...
        /**
         * Method that build a board(new board with a given builder)
         * @return new board
         */
        public Board build(){
    ...
    /**
     * Method that returns algebraic notation position for a given coordinate
     * @param coordinate given coordinate
     * @return algebraic notation
     */
    public String getPositionAtCoordinate(final int coordinate){
        String[] algebraicNotation = {"a8", "b8", "c8", "d8", "e8", "f8", "g8", "h8",
